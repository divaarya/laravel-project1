<x-admin.layout title="Teacher List">
    ...
    <div class="max-w-6xl mx-auto px-6 py-8">
        ...
        <p class="text-gray-300 mb-6">
            Berikut daftar guru beserta email & nomor telepon.
        </p>
        ...
        <div class="overflow-x-auto rounded-lg border border-gray-800 shadow-lg">
            <table class="w-full text-sm bg-gray-950 text-gray-100">
                        ...
                        <tr class="border-b border-gray-800 hover:bg-gray-900 transition">
                            ...
                            <td class="px-6 py-4 text-right relative">
                                ...
                                <div
                                    ...
                                    <a href="{{ route('admin.teacher.deletePage', $teacher->id) }}"
    ...
    <div id="addModal"
        class="fixed inset-0 hidden bg-gray-900/70 backdrop-blur-sm flex justify-center items-center z-50">
        ...
        <div class="bg-gray-900 text-gray-100 rounded-xl shadow-2xl w-full max-w-2xl p-6 relative border border-gray-700">
            ...
            <h2 class="text-xl font-bold mb-6 text-center text-white">Tambah Teacher</h2>
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="name"
                            class="w-full bg-gray-950 border border-gray-700 rounded-lg p-2 focus:ring-2 focus:ring-green-500"
                            required>
                    </div>
